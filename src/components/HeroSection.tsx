...
const HeroSection = () => {
  return (
    <section className="min-h-screen pb-20 md:pt-40 pt-32 px-6 sm:px-10 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16 relative z-10 animate-fade-in-up">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 gradient-text">
            <span className='text-white'>Revolutionize Your</span> Revenue Analytics
          </h1>
